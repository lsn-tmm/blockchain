...
# DIRECT-WIN.PY ------------------------------------------
# --------------------------------------------------------
# Try automatically win a direct after the correct
# period of time, maybe increasing gasPrice
# With logging, passing args via cmd line
#
# usage: direct-win.py [-h] team flag dtime multiplier
#
...
from solb.mng import direct_check
import time
import argparse
...
if __name__ == '__main__':
    ...
    # Win a direct challenge
    time.sleep(int(args.dtime))
    direct_check(cnt_dict,
                 args.team.upper(),
                 int(args.flag),
